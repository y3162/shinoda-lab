...
def build_datasets(config):
    ...
    if data.dataset == 'voicebank':
        ...
        trainset = VoiceBankPairDataset(
            training_indexes,
            _voicebank_audio_dir(vb.clean_train_dir, data.sampling_rate),
            _voicebank_audio_dir(vb.noisy_train_dir, data.sampling_rate),
            data.segment_size,
            data.sampling_rate,
            split=True,
        )
        validset = VoiceBankPairDataset(
            validation_indexes,
            _voicebank_audio_dir(vb.clean_valid_dir, data.sampling_rate),
            _voicebank_audio_dir(vb.noisy_valid_dir, data.sampling_rate),
            data.segment_size,
            data.sampling_rate,
            split=False,
        )
